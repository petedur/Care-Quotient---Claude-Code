...
module.exports = async function handler(req, res) {
  ...
  if (messages.length > 20) {
    return res.status(400).json({ error: 'Message history too long (max 20 messages)' });
  }
