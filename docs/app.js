  ...
  app.innerHTML = [
    '<div class="method-page findings-page">',
      ...
      '<p>',
        ...
        'or how much residents emotionally care about one another. It measures care capacity, the visible ',
      ...
      '<p>',
        ...
        'the denominator got smaller while institutions largely stayed. To verify that hypothesis, however, ',
        'we need institution-level histories (when facilities opened, when capacity changed, what the trend lines ',
        'look like, etc). This index purely reflects the current state of care; we need to dig deeper to ',
        'understand the story of each city.',
      '</p>',

      '<p>',
        'Residential stability is also extremely high, with Detroit at 91.8 and Cleveland at 85.7. ',
      ...
      '<p>',
        ...
        'The absence of expansion relative to most other states likely suppresses FQHC funding and development too.',
      '</p>',
      ...
      '<p>',
        "SF's housing cost burden score is 73.8, meaning that roughly a third of households are cost-burdened. ",
      ...
      '<p>',
        '<strong>Salt Lake City SNAP: 34.9.</strong> This is the lowest food security program reach in the dataset ',
      ...
      '<p>',
        ...
        'potentially attributable to a legacy of HBCUs, civil rights organizations, and Black church networks. But Pillar 2 is 58.3 and ',
