  ...
  app.innerHTML = [
    '<div class="method-page">',
      ...
      '<p>',
        ...
        'Joan Tronto, gives this project its basic orientation.',
      '</p>',

      '<h2>Why care about care?</h2>',

      '<p>It seems we should care about care for two big reasons.</p>',

      '<p>',
        'First, it is part of what lets a society do ambitious things together. Trust and ',
        '<strong>social capital</strong> make cooperation broader, steadier, and easier to sustain ',
        'over time. The OECD treats trust as a key ingredient of growth, social cohesion, well-being, ',
        'and governance, and the National Academies describes social capital and connectedness as ',
        'community assets that help communities function and recover from shocks. In Chicago, Robert ',
        'Sampson, Stephen Raudenbush, and Felton Earls found that neighborhoods with stronger ',
        '<strong>collective efficacy</strong> &mdash; social cohesion combined with a willingness to ',
        'act for the common good &mdash; experienced lower violence, and that some of the harms ',
        'associated with concentrated disadvantage and residential instability worked through weaker ',
        'collective efficacy. I take the larger lesson to be that care helps societies coordinate. ',
        'It makes it easier to build institutions, carry public burdens, and keep working together ',
        'when life gets difficult.',
      '</p>',

      '<p>',
        'Second, caring seems to be good for the person doing it. There is now a meaningful body of ',
        'research suggesting that prosocial behavior is tied to better well-being, and in some cases ',
      ...
      '<p>',
        'I think care begins with attention. People have to be able to notice one another before they ',
        'can really respond to one another.',
      '</p>',
      ...
      '<p>',
        'That is part of why I put so much weight on <strong>residential stability</strong> and on the ',
        'local organizations that hold communities together. Those measures are imperfect. Stable ',
        'housing can reflect attachment and durable social ties, and it can also reflect constraint. ',
        'Even so, the basic intuition still matters: when people are rooted, care has something to ',
        'grow on.',
      '</p>',

      '<p>',
        'I also think public spaces matter here. Libraries, for example, do not solve care on their ',
        'own. They do help create the civic texture in which care becomes more likely. They are among ',
        'the few institutions that receive people without much sorting or gatekeeping. People can show ',
        'up there without money, status, or an appointment. That kind of open presence matters more ',
      ...
      '<p>',
        'Care lives in relationships, and it also has to be built into institutions.',
      '</p>',
      ...
      '<p>',
        'This is one reason I do not want to keep care entirely inside the family or the private ',
        'sphere. Care is also a public problem. A city that relies only on private goodwill will leave ',
        'the people with the fewest resources, the weakest networks, or the greatest needs with too ',
      ...
      '<p>',
        'Having care infrastructure on paper is one thing. People still need a path to it.',
      '</p>',

      '<p>',
        'That is why the index includes measures like health coverage, housing affordability, and ',
        'safety-net reach. These are conditions of access. They shape whether the care a city nominally ',
        'possesses can actually be received.',
      '</p>',

      '<p>',
        'This matters because a city can have good organizations and still fail to reach the people ',
      ...
      '<p>',
        'That is the logic behind the three pillars. The first is relational. The second is ',
        'institutional. The third is about access.',
      '</p>',

      '<p>',
        'These are practical categories rather than philosophical absolutes. I use them because they ',
        'let me turn a moral idea into something measurable without flattening it completely.',
      '</p>',

      '<h2>Limits of this index</h2>',

      '<p>',
        'The Care Quotient is a partial measure of care capacity. It is useful to me because it ',
        'captures some of the conditions under which care becomes more likely. It leaves a great ',
        'deal out.',
      '</p>',
      ...
      '<p>',
        'So this project makes a narrower claim. It asks whether a city has built the social ties, ',
        'organizations, and access conditions that make it easier for people to get help when they ',
        'need it. That is only part of what makes a good society. It is still a meaningful part.',
      '</p>',
