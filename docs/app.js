  ...
  app.innerHTML = [
    '<div class="method-page">',
      ...
      '<table class="method-table">',
        '<thead><tr>',
          '<th>Pillar</th><th>What it measures (metric weights within pillar)</th><th>Pillar weight</th>',
        '</tr></thead>',
        '<tbody>',
          '<tr>',
            '<td><span class="ptag ptag-p1">Social &amp; Relational Care</span></td>',
            '<td>',
              '<ul style="margin:0;padding-left:20px;"><li>Residential stability (50%)</li><li>Care nonprofit density (40%)</li><li>Library density (5%)</li><li>Religious organization density (5%)</li></ul>',
              '<em style="font-size:0.9em;display:block;margin-top:6px;">The conditions under which people notice and respond to need.</em>',
            '</td>',
            '<td>40% of CQ</td>',
          '</tr>',
          '<tr>',
            ...
            '<td>',
              '<ul style="margin:0;padding-left:20px;"><li>FQHC density (45%)</li><li>Nursing home capacity (35%)</li><li>Child care capacity (20%)</li></ul>',
              '<em style="font-size:0.9em;display:block;margin-top:6px;">Formal institutions designed to absorb distress at scale.</em>',
            '</td>',
            '<td>35% of CQ</td>',
          '</tr>',
          '<tr>',
            ...
            '<td>',
              '<ul style="margin:0;padding-left:20px;"><li>Healthcare coverage (40%)</li><li>Housing affordability (35%)</li><li>SNAP participation (25%)</li></ul>',
              '<em style="font-size:0.9em;display:block;margin-top:6px;">Whether economic conditions allow care to reach those who need it.</em>',
            '</td>',
            '<td>25% of CQ</td>',
          '</tr>',
        '</tbody>',
