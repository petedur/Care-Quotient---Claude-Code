...
function renderFindings(app) {
  app.innerHTML = [
    '<div class="method-page findings-page">',
      ...
      '<p>',
        'Six patterns that emerge from the full dataset &mdash; some confirming what we expected, ',
        'some genuinely counterintuitive.',
      '</p>',

      '<p>',
        'The strongest through-line is that care capacity is not the same as prosperity, population growth, ',
        ...
        'make care more possible. Medicaid non-expansion shows that care is not just whether organizations exist, ',
        'but whether people can actually reach them. That is exactly what this index is designed to surface.',
      '</p>',

      '<p>',
        'One note on how to read these findings: the CQ does not measure compassion, altruism, civic virtue, ',
        'or how much residents emotionally care about one another. It measures care capacity &mdash; the visible ',
        'conditions through which care can be organized and delivered. A high score may be consistent with a ',
      ...
      '<p>',
        ...
        'Nursing homes at 100, child care at 100, FQHCs at 81.9. One plausible explanation is that some of ',
        'this reflects legacy infrastructure built for a larger historical population: as population shrank, ',
        'the denominator got smaller while institutions largely stayed. But to verify that, you would need ',
        'institution-level histories &mdash; when facilities opened, when capacity changed, what the trend lines ',
        'look like. The data shows high density; it does not prove why.',
      '</p>',

      '<p>',
        'Residential stability is also extremely high &mdash; Detroit at 91.8, Cleveland at 85.7. ',
        'People stay. The social ties that enable informal care form when people stay put. ',
      ...
      '<p>',
        ...
        '35% of likely-eligible households. One plausible explanation is that LDS mutual aid partially ',
        'substitutes for formal SNAP participation. The CQ cannot measure that informal care &mdash; which is ',
        'a real limit of what the index can see.',
      '</p>',
      ...
      '<p>',
        ...
        'participation, or some combination of the above. This is exactly where the CQ should be read as a ',
        'diagnostic prompt rather than a final verdict.',
      '</p>',
      ...
      '<p>',
        'The CQ measures formal care infrastructure. It cannot measure LDS ward welfare systems, ',
        'immigrant mutual aid networks in LA and Houston, extended family care systems, or informal support ',
        'that substitutes for enrollment. Cities where informal care is strong and formal program participation ',
        'is low will score lower than their actual care capacity.',
      '</p>',
