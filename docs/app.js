  ...
  app.innerHTML = [
    '<div class="method-page">',
      ...
      '<p>',
        ...
        'social capital make cooperation broader, steadier, and easier to sustain ',
        ...
        'collective efficacy &mdash; social cohesion combined with a willingness to ',
      ...
      '<p>',
        'That is part of why I put so much weight on residential stability and on the ',
      ...
      '<p>',
        ...
        'safety-net reach. These are conditions of access &mdash; whether the care a city has on ',
        'paper can actually reach people who need it.',
      '</p>',
